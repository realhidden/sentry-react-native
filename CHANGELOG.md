...
- Bump JavaScript SDK from v8.55.0 to v10.34.0 ([#3](https://github.com/realhidden/sentry-react-native/pull/3))
  - [changelog](https://github.com/getsentry/sentry-javascript/blob/develop/CHANGELOG.md#10340)
  - [diff](https://github.com/getsentry/sentry-javascript/compare/8.55.0...10.34.0)
