...
- Bump CLI from v2.50.2 to v3.1.0 ([#5](https://github.com/realhidden/sentry-react-native/pull/5))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#310)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.50.2...3.1.0)
