...
- Bump JavaScript SDK from v8.55.0 to v10.10.0 ([#3](https://github.com/realhidden/sentry-react-native/pull/3))
  - [changelog](https://github.com/getsentry/sentry-javascript/blob/develop/CHANGELOG.md#10100)
  - [diff](https://github.com/getsentry/sentry-javascript/compare/8.55.0...10.10.0)
