...
- Bump Bundler Plugins from v4.0.2 to v4.2.0 ([#7](https://github.com/realhidden/sentry-react-native/pull/7))
  - [changelog](https://github.com/getsentry/sentry-javascript-bundler-plugins/blob/main/CHANGELOG.md#420)
  - [diff](https://github.com/getsentry/sentry-javascript-bundler-plugins/compare/4.0.2...4.2.0)
