...
- Bump Android SDK from v7.22.6 to v8.30.0 ([#1](https://github.com/realhidden/sentry-react-native/pull/1))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8300)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.22.6...8.30.0)
